...
export default function Contactus() {
  return (
    ...
    <div>
      <div className="mx-auto mt-10 rounded-2xl w-4/5 lg:max-w-6xl">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
          Please get in touch and our expert support team will answer all your
          questions.
        </h1>
        <p className="text-base text-zinc-600 dark:text-zinc-400">
          Email us with any question or inquires. We should happy to answer your
      ...
      <form
        action="/thank-you"
        className="mx-auto mt-10  rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40 w-4/5 lg:max-w-6xl"
      >
