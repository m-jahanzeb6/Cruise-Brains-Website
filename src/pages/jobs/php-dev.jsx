...
function phpDev(previousPathname) {
  return (
    <>
            ...
            <div className="mt-20 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              ...
              <div className="w-full px-1">
                ...
                <ul className="list-outside list-disc">
                  ...
                  <li>
                    Developing back-end components and connecting the
                    application to web services
                  </li>

                  <li>
                    Ensuring high performance and responsiveness to requests
                    from the front-end
                  </li>
                  <li>
              ...
              <p>
                ...
                working closely with clients and other stakeholders throughout
